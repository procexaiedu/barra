          ...
          <div className={cn(
            ...
            <section className="rounded-lg border border-border bg-surface p-4">
              ...
              <textarea
                ...
                className="mt-2 min-h-24 w-full rounded-lg border border-input bg-input px-3 py-2 text-sm text-text-primary outline-none transition-colors placeholder:text-text-muted hover:border-border-strong focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:opacity-60"
              />
...
const selectClass =
  "h-10 w-full appearance-none rounded-lg border border-input bg-input pl-3 pr-9 text-sm text-text-primary outline-none transition-colors hover:border-border-strong focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-60"
