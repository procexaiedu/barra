...
- **Status (GA — doc oficial `claudedocs/structuredOUT.md`, auditoria 2026-05-24):** Structured Outputs (JSON outputs + strict tool use) são **GA, sem beta header**. O header antigo `structured-outputs-2025-11-13` ainda funciona num período de transição, mas é dispensável — não passar `betas=[...]` para isto. **Confirmar suporte do modelo** mesmo assim (Opus 4.7 / Sonnet 4.6 — ambos suportados).
