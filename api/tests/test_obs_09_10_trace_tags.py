...
def test_ids_surgem_como_metadata_e_tags_do_trace() -> None:
    ...
    config |= metadata_trace_turno(_MODELO_ID, _ATENDIMENTO_ID)
...
def test_gen_ai_conversation_id_e_o_atendimento() -> None:
    frag = metadata_trace_turno(_MODELO_ID, _ATENDIMENTO_ID)
...
def test_ids_sobrevivem_ao_anonymizer_sec10() -> None:
    ...
    for chave in ("modelo_id", "atendimento_id", tracing._GEN_AI_CONVERSATION_ID):
