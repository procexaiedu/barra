...
def test_mapa_clientes_propaga_estado_em_andamento() -> None:
    # "em andamento" não é um valor único do enum: qualquer estado não-terminal cabe
    # (Triagem/Qualificado/Aguardando_confirmacao/Confirmado/Em_execucao). MAPA-3
    # colore esses três grupos como verde/vermelho/âmbar — basta garantir que o
    # estado bruto chega ao payload para o frontend mapear a cor.
    async def _override():
