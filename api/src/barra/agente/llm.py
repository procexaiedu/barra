...
Invariante (agente/CLAUDE.md): BP_GERAL (persona+regras+FAQ) é GERAL — byte-idêntico entre todas
...
def build_system_messages(
    ...
    **Fusão BP_GERAL**: persona+regras+FAQ entram num bloco system único — antes eram 2 separados
