...
async def export_receitas(
    ...
    headers_csv = [
        "data", "numero_curto", "modelo", "cliente", "forma_pagamento",
        "valor_bruto", "percentual_repasse", "valor_repasse_calculado",
    ]
    rows: list[list[Any]] = [
        [
            it.fechado_em,
            ...
            _fmt_br(it.percentual_repasse_snapshot) if it.percentual_repasse_snapshot is not None else "",
